			...
			skills: [
				{
					name: "프로그래밍언어1",
               description: {
				  text: "C언어의 기초 구문을 이해하고 함수를 이용한 기초적인 프로그램 작성기법을 익힌다. (전공필수(3학점))",
					...
					skills: [
						{
							name: "그래픽스 프로그래밍",
							description: {
								text: "CPU에서 수행되는 WebGL/OpenGL/DirectX 등 3D그래픽스 API 프로그래밍 및 GPU에서 수행되는 GLSL/HLSL 등 GPU 프로그래밍의 기초적인 개념과 방법 그리고 이들 간의 연동에 관하여 다룬다. (전공선택(3학점)",
			...
			skills: [
				{
					...
					description: {
					 ...
					 },
					 {
						name: "현장실습",
						description: {
							text: "전공교과목에서 배운 지식을 토대로 산업현장에서 실무를 맡아 수행함으로서 현장에 대한 이해를 높이고 지식의 실제적 적용능력을 기른다. (전공선택(1학점)",
